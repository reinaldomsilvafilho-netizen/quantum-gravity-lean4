...
1. **Atualização dos Metadados Institucionais:**
   - Autor atualizado para Reinaldo Maia Silva-Filho, Programa de Pós-Graduação em Estatística e Experimentação Agropecuária (PPGEE/DES), Universidade Federal de Lavras (UFLA).
