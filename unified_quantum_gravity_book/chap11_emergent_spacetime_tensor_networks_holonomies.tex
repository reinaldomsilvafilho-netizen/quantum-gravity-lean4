...
In the Sachdev--Ye--Kitaev (SYK) model and random tensor models of Gurau--Witten \cite{kitaev2015simple, maldacena2016bound}, the black hole horizon is modeled by a $k$-body interaction tensor $\mathcal{J}_{i_1 \dots i_k}$ of Gaussian random variables:
\begin{equation}
