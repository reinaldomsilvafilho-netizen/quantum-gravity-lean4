...
\end{equation}
Over a cosmological propagation distance $D_L(z) = (1+z)\frac{c}{H_0} \int_0^z \frac{\dif z'}{\sqrt{\Omega_m(1+z')^3 + \Omega_\Lambda}}$, two frequency components $f_1$ and $f_2$ emitted simultaneously by a catastrophic source (such as an intermediate-mass or supermassive binary black hole merger) experience a cumulative differential arrival time delay:
\begin{equation}
    \label{eq:delta_t}
...
\doi{10.1007/s10909-019-02150-1}.
