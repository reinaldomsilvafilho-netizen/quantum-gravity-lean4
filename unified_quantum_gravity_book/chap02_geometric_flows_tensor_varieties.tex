...
In \cite{silvafilho2026functional}, we proved the Coarea formula $\TV(W_A) = \int_{-\infty}^\infty \mathcal{H}^1(\partial^* E_t) \dif t$. We now dynamically evolve these level sets.
