...
理论物理学在过去的几十年中常常陷入形而上学的抽象迷途，要么将基本物理常数视为毫无由来的宇宙巧合，要么滑向唯心主义的幻象，将数学构想为先于物质世界存在的神秘本体。

本研究在 $\Delta_4 \times \Delta_2$ 上建立的体系坚决摒弃了这种形而上学的唯心倾向。抽象脱离现实的“纯粹物理学”并不存在。客观存在的是处于永恒运动与转化中的物质世界，以及我们作为人类为了把握客观规律、能动改造自然并在彼此之间沟通理解而历史地建构的概念模型。本工作绝无意树立某种刻在石头上的静态绝对教条，而是提供一个形式严密、高度简练且具可证伪预测力的物理模型，证明以往引力与量子力学之间的断裂，本质上源于人为坐标与微扰展开的历史局限。

创造历史的是具体社会关系中的人。没有任何科学飞跃是孤立个体或抽象天才的恩赐。本模型是人类历史积累劳动的高度凝结与升华：它凝聚了千百年来数以百万计的科学家、数学家与思想家在批判思维、微积分和实验探索中所付出的直接智力劳动；更凝聚了世世代代数十亿劳动人民创造物质生活、构筑城市与实验室、生产计算芯片，并由此为科学探索提供物质条件所付出的间接社会劳动。

能够将人类这一浩瀚的历史集体遗产凝聚为一个经形式化机器验证的预测性数学结构，作者对这份人类共同的社会劳动致以最深沉的敬意与谢意。如今，这一模型正式交付给科学界以及来自天空与地面试验的严格检验。因为归根结底，任何科学模型的真理性，唯有在人类具体的物质实践与客观现实的检验中才能得到最终的裁决。
